...
#[axum::async_trait]
impl<B, Fun, Fut> Handler<B, (), crate::input::HealthcheckInput> for Fun
where
    Fun: FnOnce(crate::input::HealthcheckInput) -> Fut + Clone + Send + 'static,
    Fut: std::future::Future<Output = crate::output::HealthcheckOutput> + Send,
        ...
        From<<B as aws_smithy_http_server::HttpBody>::Error>,
{
    ...
    async fn call(self, req: http::Request<B>) -> http::Response<aws_smithy_http_server::BoxBody> {
        ...
        let input_wrapper = match crate::operation::HealthcheckOperationInputWrapper::from_request(
            &mut req,
        )
        .await
        {
        ...
        let output_wrapper: crate::operation::HealthcheckOperationOutputWrapper =
            output_inner.into();
        output_wrapper
            .into_response()
            .map(aws_smithy_http_server::body::box_body)
...
#[axum::async_trait]
impl<B, Fun, Fut> Handler<B, (), crate::input::RegisterServiceInput> for Fun
where
    Fun: FnOnce(crate::input::RegisterServiceInput) -> Fut + Clone + Send + 'static,
        ...
        From<<B as aws_smithy_http_server::HttpBody>::Error>,
{
    ...
    async fn call(self, req: http::Request<B>) -> http::Response<aws_smithy_http_server::BoxBody> {
        ...
        use axum::response::IntoResponse;
        let input_wrapper =
            match crate::operation::RegisterServiceOperationInputWrapper::from_request(&mut req)
                .await
            {
                Ok(v) => v,
                Err(r) => {
        ...
        let input_inner = input_wrapper.into();
        let output_inner = self(input_inner).await;
        let output_wrapper: crate::operation::RegisterServiceOperationOutputWrapper =
            output_inner.into();
        output_wrapper
            .into_response()
            .map(aws_smithy_http_server::body::box_body)
...
#[axum::async_trait]
impl<B, Fun, Fut, S>
    Handler<B, aws_smithy_http_server::Extension<S>, crate::input::HealthcheckInput> for Fun
where
    S: Send + Clone + Sync + 'static,
    Fun: FnOnce(crate::input::HealthcheckInput, aws_smithy_http_server::Extension<S>) -> Fut
        + Clone
        + Send
        + 'static,
    Fut: std::future::Future<Output = crate::output::HealthcheckOutput> + Send,
...
#[axum::async_trait]
impl<B, Fun, Fut, S>
    Handler<B, aws_smithy_http_server::Extension<S>, crate::input::RegisterServiceInput> for Fun
where
    S: Send + Clone + Sync + 'static,
    Fun: FnOnce(crate::input::RegisterServiceInput, aws_smithy_http_server::Extension<S>) -> Fut
        + Clone
        + Send
        + 'static,
    Fut: std::future::Future<
